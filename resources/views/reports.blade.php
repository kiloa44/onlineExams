                            ...
                            <form class="form">
                                <div class="form-actions right">
                                    <button type="button" class="btn btn-warning mr-1" data-toggle="modal"
                                        ...
                                        <i class="ft-plus"></i>تقرير جديد
                                    </button>
                                </div>

                                <div class="form-body">
                                    <h4 class="form-section"><i class="ft-user"></i>التقارير</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <label class="modal-title text-text-bold-600" id="myModalLabel33">إضافة تقرير جديد</label>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="form-addnewReport" action="#">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="report_type" class="form-control" placeholder="نوع التقرير" name="report_type">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="report_status">حالة التقرير</label>
                                            <input type="text" id="report_status" class="form-control" placeholder="حالة التقرير" name="report_status">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="export_date">تاريخ الإضدار</label>
                                            <input type="date" id="export_date" class="form-control" placeholder="تاريخ الإصدار" name="export_date">
                                        </div>
                                    </div>
...
{{--                                    <div class="col-md-4">--}}
{{--                                        <div class="form-group">--}}
{{--                                            <label for="guardian_report_type">رقم هوية ولي الامر</label>--}}
{{--                                            <input type="text" id="guardian_report_type" class="form-control" placeholder="رقم هوية ولي الامر" name="guardian_report_type">--}}
{{--                                        </div>--}}
                                    </div>
                                </div>
{{--                                <div class="row">--}}
...
{{--                                </div>--}}
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" onclick="addnewReport()"><i class="fa fa-save"></i> إضافة</button>
...
{{--                                    </div>--}}
    ...
    <script>
        function addnewReport() {
            ...
            var data=getFormData($("#form-addnewReport"));
            //console.log(data);
            axios({
                method:'post',
                url:'localhost',
                {{--url:'{{ route("addnewReport") }}',--}}
                responseType:'json',
                data:data
        ...
        function editStudent(item) {
            ...
            axios({
                ...
                $('#editStudent #form-editStudent #report_type').val(response.data.data.report_type).trigger('change');
                ...
                $("#editStudent #form-editStudent #guardian_report_type").val(response.data.data.guardian_report_type);
