                            ...
                            <form class="form">
                                <div class="form-body">
                                    ...
                                    <div class="row icheck_minimal skin">
                                        <div class="col-sm-4">
                                            <label class="text-primary">الدورات التدريبية</label>
                                            <hr>
                                            <fieldset>
                                                <input type="checkbox" id="input-1">
                                                <label for="input-1">إضافة دورة</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="input-2" checked>
                                                <label for="input-2">تعديل دورة</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="input-3">
                                                <label for="input-3">حذف دورة</label>
                                            </fieldset>
                                            <fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <label for="input-6">رفع تقرير الدورة</label>
                                            </fieldset>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="text-primary">مركز التحفيظ</label>
                                            <hr>
                                            <fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <label for="input-8">فتح مجموعة جديدة</label>
                                            </fieldset>
                                            <fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <label for="input-10">إدخال بيانات الحفظ</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="input-11">
                                                <label for="input-11">طباعة شهادادت</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="input-12" checked>
                                                <label for="input-12">تقييم مركز التحفيظ</label>
                                            </fieldset>
